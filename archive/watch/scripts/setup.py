...
# Cookies for login-sensitive sources (Instagram Reels/Stories in particular
# often 401 or rate-limit anonymous yt-dlp requests). Set ONE of these:
#
# Read cookies straight from an installed, logged-in browser (simplest —
# just stay logged into Instagram in that browser):
